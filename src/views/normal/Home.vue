      ...
      this.axios
        ...
        .then(res => {
          if (!res.data.code) {
            ...
            this.data4 = resData.home_attack_ip_rank
            this.data3 = resData.home_attack_source_rank
            this.data2 = resData.home_attack_type_rank
            this.data1 = resData.home_be_attack_domain_rank
            this.access_num = resData.home_head_data.all_web_access_num
            this.attack_num = resData.home_head_data.all_web_attack_num
            let access = resData.home_view_trend.access_logs_data_list
            let attack = resData.home_view_trend.attack_logs_data_list
            this.line_access_trend = []
            this.line_attack_trend = []
            for (let i = 0; i < access.length; i++) {
              this.line_access_trend.push(access[i].access_num)
              this.line_attack_trend.push(attack[i].attack_num)
            }
            this.drawEcharts()
            this.spinShow = false
          }
